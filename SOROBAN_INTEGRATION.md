...
This document describes the Soroban smart contract integration for Kaystcx, which enables on-chain certificate issuance, verification, and revocation.

## Overview

The Kaystcx application now integrates with Soroban smart contracts deployed on the Stellar network. This provides:
