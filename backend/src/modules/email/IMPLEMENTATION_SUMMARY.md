...
A complete, production-ready email notification system has been implemented for the Kaystcx backend. The service supports multiple email types, async queue processing, and comprehensive error handling.
...
POST /email/send-verification
{
  "to": "user@example.com",
  "userName": "John Doe",
  "verificationLink": "https://kaystcx.com/verify?token=abc123"
}
```
...
POST /email/send-password-reset
{
  "to": "user@example.com",
  "userName": "John Doe",
  "resetLink": "https://kaystcx.com/reset?token=xyz789"
}
```
